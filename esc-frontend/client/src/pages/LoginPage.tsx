      ...
      <div className="space-y-8">
        <div className="space-y-3 rounded-[1.75rem] border border-esc-border bg-white/92 p-6 shadow-[0_16px_36px_rgba(0,0,0,0.05)] sm:p-8">
          ...
          <p className="max-w-2xl text-sm leading-7 text-esc-black-soft/75 sm:text-base">
            Sign in to continue to the appropriate workspace. Choose your role and enter your token.
          </p>
        </div>
        ...
        <div className="rounded-[1.75rem] border border-esc-border bg-white/94 p-6 shadow-[0_18px_44px_rgba(0,0,0,0.06)] sm:p-8">
          <div className="mb-6 space-y-2 border-b border-esc-border pb-5">
            ...
            <p className="text-sm text-esc-muted">Use your assigned credentials to continue.</p>
          </div>
          ...
          >
            ...
            <label className="block space-y-2">
              <span className="text-xs font-semibold uppercase tracking-[0.14em] text-esc-muted">Token</span>
              <input
            ...
            <button className="w-full rounded-xl border border-esc-pink bg-esc-pink px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:border-esc-pink-dim hover:bg-esc-pink-dim">
              Login
            </button>
          </form>

          <div className="mt-6 rounded-xl border border-esc-border bg-esc-surface2/70 px-4 py-3 text-xs leading-6 text-esc-muted">
            Access rights depend on your selected role and valid token.
          </div>
        </div>
      </div>
    </section>
